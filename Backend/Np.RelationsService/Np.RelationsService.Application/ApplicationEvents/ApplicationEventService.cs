...
using Np.RelationsService.Application.ApplicationEvents.Notes.NoteCreated;
using Np.RelationsService.Application.ApplicationEvents.Notes.NoteRemoved;
using Np.RelationsService.Application.ApplicationEvents.Relations.RelationCreated;
using Np.RelationsService.Application.ApplicationEvents.Relations.RelationRemoved;
