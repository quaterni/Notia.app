...
{
    internal class RemoveRelationCommandHandler : ICommandHandler<RemoveRelationByIdCommand>
    {
        ...
        public async Task<Result> Handle(RemoveRelationByIdCommand request, CancellationToken cancellationToken)
        {
